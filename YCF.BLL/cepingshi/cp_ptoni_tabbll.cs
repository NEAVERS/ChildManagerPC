...
{
    public partial class cp_ptoni_tabbll : BLLBase<CP_PTONI_TAB, cp_ptoni_tabdal>
    {

        public CP_PTONI_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_PTONI_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_PTONI_TAB> GetList(int cd_id)
        {
