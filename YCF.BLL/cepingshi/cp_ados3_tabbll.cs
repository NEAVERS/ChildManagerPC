...
{
    public partial class cp_ados3_tabbll : BLLBase<CP_ADOS3_TAB, cp_ados3_tabdal>
    {

        public CP_ADOS3_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_ADOS3_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_ADOS3_TAB> GetList(int cd_id)
        {
