...
{
    public partial class cp_gy_tabbll : BLLBase<CP_GY_TAB, cp_gy_tabdal>
    {

        public CP_GY_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_GY_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_GY_TAB> GetList(int cd_id)
        {
