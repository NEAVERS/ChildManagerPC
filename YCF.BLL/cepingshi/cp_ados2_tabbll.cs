...
{
    public partial class cp_ados2_tabbll : BLLBase<CP_ADOS2_TAB, cp_ados2_tabdal>
    {

        public CP_ADOS2_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_ADOS2_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_ADOS2_TAB> GetList(int cd_id)
        {
