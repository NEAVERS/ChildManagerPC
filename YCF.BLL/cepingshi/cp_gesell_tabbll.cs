...
{
    public partial class cp_gesell_tabbll : BLLBase<CP_GESELL_TAB, cp_gesell_tabdal>
    {

        public CP_GESELL_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_GESELL_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_GESELL_TAB> GetList(int cd_id)
        {
