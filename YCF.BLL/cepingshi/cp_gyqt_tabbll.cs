...
{
    public partial class cp_gyqt_tabbll : BLLBase<CP_GYQT_TAB, cp_gyqt_tabdal>
    {

        public CP_GYQT_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_GYQT_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_GYQT_TAB> GetList(int cd_id)
        {
