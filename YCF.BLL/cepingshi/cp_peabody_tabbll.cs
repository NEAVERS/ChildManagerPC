...
{
    public partial class cp_peabody_tabbll : BLLBase<CP_PEABODY_TAB, cp_peabody_tabdal>
    {

        public CP_PEABODY_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_PEABODY_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_PEABODY_TAB> GetList(int cd_id)
        {
