...
{
    public partial class cp_ados1_tabbll : BLLBase<CP_ADOS1_TAB, cp_ados1_tabdal>
    {

        public CP_ADOS1_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_ADOS1_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_ADOS1_TAB> GetList(int cd_id)
        {
