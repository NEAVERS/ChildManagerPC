...
{
    public partial class cp_sm_tabbll : BLLBase<CP_SM_TAB, cp_sm_tabdal>
    {

        public CP_SM_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_SM_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_SM_TAB> GetList(int cd_id)
        {
