...
{
    public partial class cp_wisc_tabbll : BLLBase<CP_WISC_TAB, cp_wisc_tabdal>
    {

        public CP_WISC_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_WISC_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_WISC_TAB> GetList(int cd_id)
        {
