...
{
    public partial class cp_ados4_tabbll : BLLBase<CP_ADOS4_TAB, cp_ados4_tabdal>
    {

        public CP_ADOS4_TAB GetByCdId(int cd_id)
        {
        ...
        public bool SaveOrUpdate(CP_ADOS4_TAB obj)
        {
            if (obj.ID != 0)
        ...
        public IList<CP_ADOS4_TAB> GetList(int cd_id)
        {
