...
namespace login.Hospital.DAL
{
    class LisDateLogic
    {
        ...
        public LisDateLogic()
        {
            db_name = OperatFile.GetIniFileString("DataBase", "lis_db_name", "", Application.StartupPath + "\\jianyi.ini");
            db_server = OperatFile.GetIniFileString("DataBase", "lis_db_server", "", Application.StartupPath + "\\jianyi.ini");
            UserID = OperatFile.GetIniFileString("DataBase", "lis_UserID", "", Application.StartupPath + "\\jianyi.ini");
            Pwd = OperatFile.GetIniFileString("DataBase", "lis_Pwd", "", Application.StartupPath + "\\jianyi.ini");
