...
{
    public partial class PanelGaoweizhuananPrinter : UserControl
    {
        ...
        ChildGaoweigeanObj _gaoweigeanobj = null;


        public PanelGaoweizhuananPrinter(DataGridView dataGridView,ChildBaseInfoObj baseobj,ChildGaoweigeanObj gaoweigeanobj)
        {
            InitializeComponent();
        ...
        public void Print(string printer, bool isPreview)
        {
            ...
            printDoc.DocumentName = "高危儿童专案管理记录";
        ...
        private void PrintHeaders(Graphics g)
        {
            ...
            using (Brush brush = new SolidBrush(Color.Black))
            {
                ...
                if (_gaoweigeanobj != null)
                {
                    ...
                    g.DrawString(Convert.ToDateTime(_gaoweigeanobj.managetime).ToString("yyyy年MM月dd日"), new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    ...
                    rect = new Rectangle(left, top, 80, _patientInfoHeight);
                    g.DrawString("母亲姓名:", new Font("Arial Unicode MS", 11f), brush, rect, sfleft);
                    left += 80;

                    rect = new Rectangle(left, top, 170, _patientInfoHeight);
                    g.DrawString(_baseobj.MotherName, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 170;

                    rect = new Rectangle(left, top, 100, _patientInfoHeight);
                    g.DrawString("家庭住址:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 100;

                    rect = new Rectangle(left, top, 380, _patientInfoHeight);
                    ...
                    rect = new Rectangle(left, top, 80, _patientInfoHeight);
                    g.DrawString("转诊单位:", new Font("Arial Unicode MS", 11f), brush, rect, sfleft);
                    left += 80;

                    rect = new Rectangle(left, top, 240, _patientInfoHeight);
                    g.DrawString(_gaoweigeanobj.zhuanzhendanwei, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 240;

                    rect = new Rectangle(left, top, 80, _patientInfoHeight);
                    g.DrawString("高危因素:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 80;

                    rect = new Rectangle(left, top, 240, _patientInfoHeight);
                    g.DrawString(_baseobj.gaowei, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 240;

                    rect = new Rectangle(left, top, 120, _patientInfoHeight);
                    g.DrawString("既往患病情况:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 120;

                    rect = new Rectangle(left, top, 240, _patientInfoHeight);
                    g.DrawString(_gaoweigeanobj.jiwangshi, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    ...
                    g.DrawString(_gaoweigeanobj.zhuangui, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 165;
                    ...
                    rect = new Rectangle(left, top, 190, _patientInfoHeight);
                    if (!string.IsNullOrEmpty(_gaoweigeanobj.endtime)&&_gaoweigeanobj.endtime!="0001-01-01")
                    {
                        g.DrawString(Convert.ToDateTime(_gaoweigeanobj.endtime).ToString("yyyy-MM-dd"), new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    }
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
