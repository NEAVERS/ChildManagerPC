...
{
    public partial class cp_ados3_printer : UserControl
    {
        ...
        private void PrintBody(Graphics g)
        {
            ...
            top += height;
            rectProjectName = new Rectangle(left, top, _rectBody.Width, height);
            MiddleCenterPrintText("自闭症诊断观察量表（ADOS）  单元三", new Font("宋体", 16f, FontStyle.Bold), new SolidBrush(Color.Black), rectProjectName, g);//画医院名称
            top += height;
            #endregion
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("报告事件", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.GT_BGSJ, rect, g);
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("洞察力", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.HD_DCL, rect, g);
            ...
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.HD_XHXSH, rect, g);
