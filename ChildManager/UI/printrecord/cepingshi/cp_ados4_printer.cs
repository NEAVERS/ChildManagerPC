...
{
    public partial class cp_ados4_printer : UserControl
    {
        private Rectangle _rectBody;

        private TB_CHILDBASE _baseobj = null;
        private CP_ADOS4_TAB _obj = null;

        public cp_ados4_printer(TB_CHILDBASE baseobj, CP_ADOS4_TAB obj)
        {
            InitializeComponent();
            _baseobj = baseobj;
            _obj = obj;
        ...
        private void PrintBody(Graphics g)
        {
            ...
            top += height;
            rectProjectName = new Rectangle(left, top, _rectBody.Width, height);
            MiddleCenterPrintText("自闭症诊断观察量表（ADOS）  单元四", new Font("宋体", 16f, FontStyle.Bold), new SolidBrush(Color.Black), rectProjectName, g);//画医院名称
            top += height;
            #endregion
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("会话", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.GT_HH, rect, g);

            top += 25;
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("描述性、惯用的、工具性的、或资讯性的姿势动作", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.GT_MSXDZ, rect, g);

            top += 25;
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("加强语气的或情绪性的姿势动作", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.GT_JJXDZ, rect, g);
            ...
            rect = new Rectangle(left, top, 400, 30);
            SmallMiddleLeftPrintText("（自闭症切截点=3 : 自闭症类群切截点=2）", rect, g);
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("对他人情绪的同理/评论", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.HD_DTRQX, rect, g);

            top += 25;
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("责任", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.HD_ZR, rect, g);
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("社交反应品质", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.HD_SJFY, rect, g);

            top += 25;
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("相互性社会沟通的数量", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.HD_XHXSHGT, rect, g);
            ...
            left = _rectBody.Left + 200;
            rect = new Rectangle(left, top, 400, 30);
            SmallMiddleLeftPrintText("（自闭症切截点=6 :  自闭症类群切截点=4 ）", rect, g);
            ...
            left = _rectBody.Left + 200;
            rect = new Rectangle(left, top, 400, 30);
            SmallMiddleLeftPrintText("（自闭症切截点=10: 自闭症类群切截点=7 ）", rect, g);
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 300, 30);
            BoldMiddleLeftPrintText("想象/创造力", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.XX_FS, rect, g);
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("强迫行为或仪式行为", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.KBXW_QPXW, rect, g);
            ...
            //rect = new Rectangle(left, top, 250, 25);
            //g.DrawRectangle(pen, rect);
            //BoldMiddleLeftPrintText("≥10分", rect, g);
            ...
            //rect = new Rectangle(left, top, 250, 25);
            //g.DrawRectangle(pen, rect);
            //BoldMiddleLeftPrintText("7-9分", rect, g);
