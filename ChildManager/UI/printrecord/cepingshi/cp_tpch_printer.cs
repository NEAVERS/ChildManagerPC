...
{
    public partial class cp_tpch_printer : UserControl
    {
        private Rectangle _rectBody;

        private TB_CHILDBASE _baseobj = null;
        private CP_TPCH_TAB _obj = null;

        public cp_tpch_printer(TB_CHILDBASE baseobj, CP_TPCH_TAB obj)
        {
            InitializeComponent();
            _baseobj = baseobj;
            _obj = obj;
        ...
        private void PrintBody(Graphics g)
        {
            ...
            MiddleLeftPrintText(_obj.TPCH_CF, rect, g);
            ...
            left += 60;
            rect = new Rectangle(left, top, 200, 30);
            MiddleLeftPrintText(_obj.TPCH_IQ, rect, g);
            ...
            left += 60;
            rect = new Rectangle(left, top, 200, 30);
            MiddleLeftPrintText(_obj.TPCH_P, rect, g);
            ...
            left += 60;
            rect = new Rectangle(left, top, 200, 30);
            MiddleLeftPrintText(_obj.TPCH_ZL_SUI, rect, g);
            ...
            left += 60;
            rect = new Rectangle(left, top, 200, 30);
            MiddleLeftPrintText( _obj.TPCH_ZL_YUE, rect, g);
