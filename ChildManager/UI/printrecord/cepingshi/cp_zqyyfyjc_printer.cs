...
{
    public partial class cp_zqyyfyjc_printer : UserControl
    {
        ...
        private void PrintBody(Graphics g)
        {
            ...
            BoldMiddleLeftPrintText("《早期语言发育进程》测试结果", cdirect, g);//画医院名称

            top += 60;
            #region 1.A语言表达能力
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 220, 30);
