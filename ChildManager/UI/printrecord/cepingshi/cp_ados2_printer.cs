...
{
    public partial class cp_ados2_printer : UserControl
    {
        private Rectangle _rectBody;

        private tb_childbase _baseobj = null;
        private cp_ados2_tab _obj = null;

        public cp_ados2_printer(tb_childbase baseobj, cp_ados2_tab obj)
        {
            InitializeComponent();
            _baseobj = baseobj;
            _obj = obj;
        ...
        private void PrintBody(Graphics g)
        {
            ...
            top += height;
            rectProjectName = new Rectangle(left, top, _rectBody.Width, height);
            MiddleCenterPrintText("自闭症诊断观察量表（ADOS）  单元二", new Font("宋体", 16f, FontStyle.Bold), new SolidBrush(Color.Black), rectProjectName, g);//画医院名称
            top += height;
            #endregion
            ...
            MiddleLeftPrintText("主动表达社交意向", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.gt_zdbd, rect, g);
            ...
            rect = new Rectangle(left, top, 400, 30);
            SmallMiddleLeftPrintText("（自闭症切截点=5 : 自闭症类群切截点=3）", rect, g);
            ...
            left = _rectBody.Left;
            rect = new Rectangle(left, top, 400, 30);
            MiddleLeftPrintText("关系的整体品质", rect, g);
            left += 400;
            rect = new Rectangle(left, top, 45, 30);
            MiddleLeftPrintTextAndLine(_obj.hd_gx, rect, g);
            ...
            left = _rectBody.Left + 200;
            rect = new Rectangle(left, top, 400, 30);
            SmallMiddleLeftPrintText("（自闭症切截点=12: 自闭症类群切截点=8 ）", rect, g);
            ...
            //rect = new Rectangle(left, top, 250, 25);
            //g.DrawRectangle(pen, rect);
            //BoldMiddleLeftPrintText("8-11分", rect, g);
            ...
            //rect = new Rectangle(left, top, 250, 25);
            //g.DrawRectangle(pen, rect);
            //BoldMiddleLeftPrintText("≤7分", rect, g);
