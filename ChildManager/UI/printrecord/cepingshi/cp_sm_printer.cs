...
{
    public partial class cp_sm_printer : UserControl
    {
        private Rectangle _rectBody;

        private TB_CHILDBASE _baseobj = null;
        private CP_SM_TAB _obj = null;

        public cp_sm_printer(TB_CHILDBASE baseobj, CP_SM_TAB obj)
        {
            InitializeComponent();
            _baseobj = baseobj;
            _obj = obj;
        ...
        private void PrintBody(Graphics g)
        {
            ...
            BoldMiddleLeftPrintText("社会适应能力测试结果", rect, g);
            
            top += 50;
            left = _rectBody.Left + 50;
            rect = new Rectangle(left, top, 70, 30);
            MiddleLeftPrintText("标准分（", rect, g);

            left += 70;
            rect = new Rectangle(left, top, 30, 30);
            MiddleLeftPrintText(_obj.BZF, rect, g);
            ...
            top += 50;
            left = _rectBody.Left + 50;
            rect = new Rectangle(left, top, 110, 40);
            MiddleLeftPrintText1("结论:"+_obj.JL, rect, g);
            ...
            MiddleLeftPrintText(_obj.SZYS, rect, g);
