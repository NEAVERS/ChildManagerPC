...
{
    public partial class cp_wisc_printer : UserControl
    {
        private Rectangle _rectBody;

        private TB_CHILDBASE _baseobj = null;
        private CP_WISC_TAB _obj = null;

        public cp_wisc_printer(TB_CHILDBASE baseobj, CP_WISC_TAB obj)
        {
            InitializeComponent();
            _baseobj = baseobj;
            _obj = obj;
        ...
        private void PrintBody(Graphics g)
        {
            ...
            top += height;
            rectProjectName = new Rectangle(left, top, _rectBody.Width, height);
            MiddleCenterPrintText("大韦氏智力测试结果", new Font("宋体", 16f, FontStyle.Bold), new SolidBrush(Color.Black), rectProjectName, g);//画医院名称
            top += height;
            #endregion
            ...
            BoldMiddleLeftPrintText("C-WISC  测试结果", rect, g);
            ...
            Rectangle lbfrect = new Rectangle(left, top, _rectBody.Width-80, lfbheight*26);
            ...
            left = lbfrect.Left+lfbwidth*7+20;
            rect = new Rectangle(left, top+10, 140, 30);
            ...
            g.DrawLine(bpen2,left,top,left+lfbwidth*6,top);
            left = lbfrect.Left + lfbwidth*7;
            ...
            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText("图形\r\n拼凑", rect, g);

            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText("编\r\n码", rect, g);
            ...
            top += lfbheight*2;
            left = lbfrect.Left + lfbwidth / 2;
            g.DrawLine(pen, left, top, left + lfbwidth * 6, top);
            left = lbfrect.Left + lfbwidth * 7;
            ...
            {
                if(i==5||i==6)
                g.DrawLine(pen, left, top, left, top + lfbheight * 2);
                else
            ...
            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.YYCY_FL, rect, g);
            listyycy.Add(_obj.YYCY_FL);
            ...
            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.YYCY_CH, rect, g);
            listyycy.Add(_obj.YYCY_CH);
            ...
            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.YYCY_SZGD, rect, g);
            listyycy.Add(_obj.YYCY_SZGD);
            ...
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.CZCY_TT, rect, g);
            listczcy.Add(_obj.CZCY_TT);

            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.CZCY_TPPL, rect, g);
            listczcy.Add(_obj.CZCY_TPPL);

            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.CZCY_MKT, rect, g);
            listczcy.Add(_obj.CZCY_MKT);

            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.CZCY_TXPC, rect, g);
            listczcy.Add(_obj.CZCY_TXPC);

            left += lfbwidth;
            rect = new Rectangle(left, top, lfbwidth, lfbheight * 2);
            MiddleCenterPrintText(_obj.CZCY_BM, rect, g);
            listczcy.Add(_obj.CZCY_BM);
            ...
            for(int i=0;i<20;i++)
            {
                ...
                rect = new Rectangle(left+lfbwidth*6+lfbwidth/2, top + i * lfbheight, lfbwidth / 2, lfbheight);
                MiddleCenterPrintText((19 - i).ToString(), rect, g);

                rect = new Rectangle(left+lfbwidth*12, top + i * lfbheight, lfbwidth / 2, lfbheight);
                MiddleCenterPrintText((19 - i).ToString(), rect, g);
            ...
            for (int i = 0; i < 20; i++)
            {
                if ((i % 2 == 0&&(i<=5||i>=15))|| i > 5 && i < 15 && i % 2 != 0)
                {
                    g.DrawLine(pen, left, top+i*lfbheight, left + lfbwidth * 6, top + i * lfbheight);
                    g.DrawLine(pen, left+lfbwidth*6+lfbwidth/2, top + i * lfbheight, left + lfbwidth * 11+ lfbwidth / 2, top + i * lfbheight);
                }
                else
                {
                    g.DrawLine(bpen2, left, top + i * lfbheight, left + lfbwidth * 6, top + i * lfbheight);
                    g.DrawLine(bpen2, left + lfbwidth * 6 + lfbwidth / 2, top + i * lfbheight, left + lfbwidth * 11 + lfbwidth / 2, top + i * lfbheight);
                }
            }
            ...
            {
                if (i == 5 || i == 6)
                    g.DrawLine(pen, left, top , left, top + lfbheight*19);
                else
                    g.DrawLine(bpen2, left, top , left, top + lfbheight*19);
            ...
            for (int i=0;i<6;i++)
            {
                ...
                {
                    Point pt = new Point(left + i*lfbwidth, top - Convert.ToInt32(listyycy[i])*lfbheight);
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                {
                    Point pt = new Point(left+lfbwidth*6+lfbwidth/2 + i * lfbwidth, top - Convert.ToInt32(listczcy[i]) * lfbheight);
            ...
            MiddleCenterPrintText(_obj.BZ, rect, g);
