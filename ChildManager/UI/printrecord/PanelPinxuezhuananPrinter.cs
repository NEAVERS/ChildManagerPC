...
{
    public partial class PanelPinxuezhuananPrinter : UserControl
    {
        ...
        public void Print(string printer, bool isPreview)
        {
            ...
            printDoc.DocumentName = "营养性缺铁性贫血儿童专案管理记录";
        ...
        private void CountPageNos(Graphics g)
        {
            ...
            _columnsPrintWidth.Add(60);
            _columnsPrintWidth.Add(240);
            _columnsPrintWidth.Add(260);
            _columnsPrintWidth.Add(240);
            _columnsPrintWidth.Add(80);
        ...
        private void PrintHeaders(Graphics g)
        {
            ...
            using (Brush brush = new SolidBrush(Color.Black))
            {
                ...
                if (_yinyanggeanobj != null)
                {
                    ...
                    rect = new Rectangle(left, top, 120, _patientInfoHeight);
                    g.DrawString("母孕期贫血情况:", new Font("Arial Unicode MS", 11f), brush, rect, sfleft);
                    left += 120;

                    rect = new Rectangle(left, top, 50, _patientInfoHeight);
                    g.DrawString("孕周:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 50;

                    rect = new Rectangle(left, top, 60, _patientInfoHeight);
                    g.DrawString(_yinyanggeanobj.yunzhou+"+"+_yinyanggeanobj.yuntian, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 60;

                    rect = new Rectangle(left, top, 30, _patientInfoHeight);
                    g.DrawString("周", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 35;

                    rect = new Rectangle(left, top, 50, _patientInfoHeight);
                    g.DrawString("Hb:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 50;

                    rect = new Rectangle(left, top, 50, _patientInfoHeight);
                    g.DrawString(_yinyanggeanobj.hb + "+" + _yinyanggeanobj.yuntian, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 50;

                    rect = new Rectangle(left, top, 40, _patientInfoHeight);
                    g.DrawString("g/dl", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 45;

                    rect = new Rectangle(left, top, 80, _patientInfoHeight);
                    g.DrawString("铁剂治疗:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 80;

                    rect = new Rectangle(left, top, 50, _patientInfoHeight);
                    g.DrawString(_yinyanggeanobj.tieji, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 50;

                    if (_yinyanggeanobj.tieji == "有")
                    {
                        rect = new Rectangle(left, top, 60, _patientInfoHeight);
                        g.DrawString("(药物:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                        left += 60;

                        rect = new Rectangle(left, top, 80, _patientInfoHeight);
                        g.DrawString(_yinyanggeanobj.yaowu, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                        g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                        left += 80;
                        ...
                        rect = new Rectangle(left, top, 80, _patientInfoHeight);
                        g.DrawString(_yinyanggeanobj.jiliang, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                        g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                        left += 80;

                        rect = new Rectangle(left, top, 60, _patientInfoHeight);
                        g.DrawString("疗程:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                        left += 60;

                        rect = new Rectangle(left, top, 80, _patientInfoHeight);
                        g.DrawString(_yinyanggeanobj.liaocheng, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                        g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                        left += 80;
                    ...
                    g.DrawString("母乳喂养情况:", new Font("Arial Unicode MS", 11f), brush, rect, sfleft);
                    left += 130;

                    rect = new Rectangle(left, top, 165, _patientInfoHeight);
                    g.DrawString(_yinyanggeanobj.muru, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    left += 165;

                    left += 175;
                    rect = new Rectangle(left, top, 200, _patientInfoHeight);
                    g.DrawString("儿童开始添加含铁食物年龄:", new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    left += 200;

                    rect = new Rectangle(left, top, 120, _patientInfoHeight);
                    g.DrawString(_yinyanggeanobj.foodchange, new Font("Arial Unicode MS", 11f), brush, rect, sf);
                    g.DrawLine(pen, rect.Left, rect.Bottom - lineOffset, rect.Right, rect.Bottom - lineOffset);
                    ...
                    g.DrawString("儿童既往患病情况:", new Font("Arial Unicode MS", 11f), brush, rect, sfleft);
                    left += 150;

                    rect = new Rectangle(left, top, 800, _patientInfoHeight);
                    ...
                    rect = new Rectangle(left, top, 45, _patientInfoHeight);
                    g.DrawString("转归:", new Font("Arial Unicode MS", 11f), brush, rect, sfleft);
                    left += 45;
