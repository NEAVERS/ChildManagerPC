...
public partial class RowMergeView : DataGridView
{
            ...
            else
            {
                ...
                if (e.RowIndex == -1)
                {
                    if (SpanRows.ContainsKey(e.ColumnIndex)) //被合并的列
                    {
                        ...
                        SolidBrush blueBrush = new SolidBrush(this.ColumnHeadersDefaultCellStyle.ForeColor);
                        g.DrawString(e.Value + "", e.CellStyle.Font, blueBrush,
                        ...
                        g.DrawString(SpanRows[e.ColumnIndex].Text, e.CellStyle.Font, blueBrush,
    ...
    private void DrawCell(DataGridViewCellPaintingEventArgs e)
    {
        ...
        if (this.MergeColumnNames.Contains(this.Columns[e.ColumnIndex].Name) && e.RowIndex != -1)
        {
            ...
            {
                var currCell = this.Rows[i].Cells[e.ColumnIndex];
                if (currCell.Value.ToString().Equals(curValue))
                {
                    ...
                    if (e.RowIndex != i)
                    {
                        cellwidth = cellwidth < currCell.Size.Width ? cellwidth : this.Rows[i].Cells[e.ColumnIndex].Size.Width;
                    }
                }
                else
                {
