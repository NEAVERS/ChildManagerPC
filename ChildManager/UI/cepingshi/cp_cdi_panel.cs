...
{
    public partial class cp_cdi_panel : UserControl
    {
        private cp_cdi_tabbll bll = new cp_cdi_tabbll();//儿童建档基本信息业务处理类
        ...
        public cp_cdi_panel(cp_WomenInfo cpwomeninfo)
        {
            InitializeComponent();
        ...
        public cp_cdi_panel(cp_WomenInfo cpwomeninfo, bool isShowTopPanel) : this(cpwomeninfo)
        {
