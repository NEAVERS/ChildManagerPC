...
{
    public partial class cp_ppvt_panel : UserControl
    {
        ...
        public cp_ppvt_panel(cp_WomenInfo cpwomeninfo)
        {
            InitializeComponent();
        ...
        public cp_ppvt_panel(cp_WomenInfo cpwomeninfo, bool isShowTopPanel) : this(cpwomeninfo)
        {
        ...
        public void print(bool ispre)
        {
            ...
            try
            {
                ...
                cp_ppvt_printer printer = new cp_ppvt_printer(baseobj, obj);
                printer.Print(ispre);
            }
            catch (Exception ex)
            {
