...
{
    public partial class cp_ados1_panel : UserControl
    {
        private cp_ados1_tabbll bll = new cp_ados1_tabbll();//儿童建档基本信息业务处理类
        ...
        public cp_ados1_panel(cp_WomenInfo cpwomeninfo)
        {
            InitializeComponent();
        ...
        public cp_ados1_panel(cp_WomenInfo cpwomeninfo, bool isShowTopPanel) : this(cpwomeninfo)
        {
        ...
        private void gt_count(object sender, EventArgs e)
        {
            ...
            int i_gt_zsdz = 0;
            int i_gt_zwdz = 0;
            int.TryParse(gt_cxtr.Text.Trim(), out i_gt_cxtr);
            int.TryParse(gt_kb.Text.Trim(), out i_gt_kb);
            int.TryParse(gt_sytrst.Text.Trim(), out i_gt_sytrst);
            int.TryParse(gt_zsdz.Text.Trim(), out i_gt_zsdz);
            int.TryParse(gt_zwdz.Text.Trim(), out i_gt_zwdz);
            int gtcou = i_gt_cxtr + i_gt_kb + i_gt_sytrst + i_gt_zsdz + i_gt_zwdz;
            ...
            int.TryParse(hd_dxhxt.Text.Trim(), out i_hd_dxhxt);
            int.TryParse(hd_hdzgxlq.Text.Trim(), out i_hd_hdzgxlq);
            int.TryParse(hd_zdbd.Text.Trim(), out i_hd_zdbd);
            int.TryParse(hd_zfdzd.Text.Trim(), out i_hd_zfdzd);
            int.TryParse(hd_zs.Text.Trim(), out i_hd_zs);
            int hdcou = i_hd_bxc + i_hd_cxtr + i_hd_dxhxt + i_hd_hdzgxlq + i_hd_zdbd + i_hd_zfdzd + i_hd_zs;
        ...
        private void yx_count(object sender, EventArgs e)
        {
            int i_yx_sywp = 0;
            int i_yx_xx = 0;
            int.TryParse(yx_sywp.Text.Trim(),out i_yx_sywp);
            int.TryParse(yx_xx.Text.Trim(), out i_yx_xx);
            yx_sum.Text = (i_yx_sywp + i_yx_xx).ToString();
        ...
        private void kbxw_count(object sender, EventArgs e)
        {
            ...
            kbxw_sum.Text = (i_kbxw_btxc + i_kbxw_dyxsc+ i_kbxw_shsz).ToString();
        }
        ...
        //     	{
        //	if(this.ActiveControl.GetType()== typeof(System.Windows.Forms.TextBox)||this.ActiveControl.GetType()== typeof(System.Windows.Forms.ComboBox)){
