...
{
    public partial class cp_hrcs_panel : UserControl
    {
        ...
        public cp_hrcs_panel(cp_WomenInfo cpwomeninfo)
        {
            InitializeComponent();
        ...
        public cp_hrcs_panel(cp_WomenInfo cpwomeninfo, bool isShowTopPanel) : this(cpwomeninfo)
        {
        ...
        public void print(bool ispre)
        {
            ...
            try
            {
                ...
                cp_hrsy_printer printer = new cp_hrsy_printer(baseobj, obj);
                printer.Print(ispre);
            }
            catch (Exception ex)
            {
