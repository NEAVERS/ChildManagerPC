...
{
    public partial class cp_rwcy_panel : UserControl
    {
        ...
        public cp_rwcy_panel(cp_WomenInfo cpwomeninfo)
        {
            InitializeComponent();
        ...
        public cp_rwcy_panel(cp_WomenInfo cpwomeninfo, bool isShowTopPanel) : this(cpwomeninfo)
        {
        ...
        public void print(bool ispre)
        {
            ...
            try
            {
                ...
                cp_rwcy_printer printer = new cp_rwcy_printer(baseobj, obj);
                printer.Print(ispre);
            }
            catch (Exception ex)
            {
