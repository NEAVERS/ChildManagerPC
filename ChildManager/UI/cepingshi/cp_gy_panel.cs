...
{
    public partial class cp_gy_panel : UserControl
    {
        private cp_gy_tabbll bll = new cp_gy_tabbll();//儿童建档基本信息业务处理类
        tab_person_databll personbll = new tab_person_databll();
        cp_WomenInfo _cpwomeninfo = null;
        private bool _isShowTopPanel;
        IList<CP_GY_TAB> _list = null;
        private CP_GY_TAB _obj;
        ...
        public cp_gy_panel(cp_WomenInfo cpwomeninfo)
        {
            InitializeComponent();
        ...
        public cp_gy_panel(cp_WomenInfo cpwomeninfo, bool isShowTopPanel) : this(cpwomeninfo)
        {
        ...
        {
            CommonHelper.setForm(new CP_GY_TAB(), panel1.Controls);
        }
