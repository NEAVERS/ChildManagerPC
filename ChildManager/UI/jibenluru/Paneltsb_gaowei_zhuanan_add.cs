...
{
    public partial class Paneltsb_gaowei_zhuanan_add : Form
    {
        private Paneltsb_gaowei_zhuanan _gaoweizhuananpanel;
        private ChildGaoweigeanRecordBll gaoweirecordbll = new ChildGaoweigeanRecordBll();
        private ChildCheckObj _checkobj;
        public Paneltsb_gaowei_zhuanan_add(Paneltsb_gaowei_zhuanan gaoweizhuananpanel, ChildCheckObj checkobj)
        {
            InitializeComponent();
