...
{
    public partial class Paneljibingguanli : UserControl
    {
        ...
        public Paneljibingguanli()
        {
            InitializeComponent();
            this.cbx_gaowei.Text = "";
            ArrayList list = gwbll.getContentlist(4);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.RowIndex != -1)
            {
                ...
                Paneljibingguanli_zhuanan yingyangzhuananmain = new  Paneljibingguanli_zhuanan(baseobj);
