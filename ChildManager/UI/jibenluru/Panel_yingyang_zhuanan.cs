...
namespace login.UI
{
    public partial class Panel_yingyang_zhuanan : UserControl
    {
        public Panel_yingyang_zhuanan _yingyangzhuananpanel;
        ...
        private void Paneltsb_yingyang_zhuanan_Load(object sender, EventArgs e)
        {
            ...
            string yingyanggeansqlstr = "select * from child_yingyanggean where childid="+_baseobj.Id;
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.RowIndex != -1)
            {
                ...
                Panel_yingyang_zhuanan_add zhuananadd = new Panel_yingyang_zhuanan_add(_yingyangzhuananpanel, checkobj);
        ...
        public void btnprint(bool ispre)
        {
            ...
            {
                string projectName = "";
                string formName = "蛋白质-能量营养不良儿童专案管理记录";
