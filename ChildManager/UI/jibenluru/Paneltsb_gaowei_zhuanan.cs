...
{
    public partial class Paneltsb_gaowei_zhuanan : Form
    {
        public Paneltsb_gaowei_zhuanan _gaoweizhuananpanel;
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.RowIndex != -1)
            {
                ...
                Paneltsb_gaowei_zhuanan_add zhuananadd = new Paneltsb_gaowei_zhuanan_add(_gaoweizhuananpanel, checkobj);
